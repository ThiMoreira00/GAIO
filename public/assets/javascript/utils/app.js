document.addEventListener('DOMContentLoaded', function () {
    ...
    dropdownToggles.forEach(function (toggle) {
        ...
        if (submenu && !submenu.classList.contains('hidden')) {
            if (chevron) {
                // mudar o ícone para "expand_less" e adicionar a classe de rotação
    ...
    // Lógica de fechar alertas flash
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        for (const form of formularios) {
            ...
            const inputs = form.querySelectorAll('input, textarea, select, option');
