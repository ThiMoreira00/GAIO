...
class Usuario extends Model
{
    ...
    /**
     * Assessor (getter) para obter o pronome do usuário
     * 
     * @return UsuarioPronome|null
     */
    public function obterPronome(): ?UsuarioPronome {
        return $this->pronome ? UsuarioPronome::fromName($this->pronome) : null;
    }
    ...
    /**
     * Mutador (setter) para atribuir o pronome do usuário
     * 
     * @param UsuarioPronome $pronome
     * @return void
     */
    public function atribuirPronome(UsuarioPronome $pronome): void {
        $this->pronome = $pronome->name;
    }
    ...
    public function atribuirEstadoCivil(UsuarioEstadoCivil $estadoCivil): void {
        $this->estado_civil = $estadoCivil->name;
    }
