<header class="flex flex-col sm:flex-row items-start sm:items-center justify-between py-4 gap-4">
    <h1 class="text-2xl/7 font-bold text-gray-900 sm:truncate sm:text-3xl">Lista de Grupos</h1>
    <div class="flex-shrink-0">
        <button type="button" class="button-primary inline-flex items-center" data-modal-trigger="modal-grupo-adicionar-form" id="button-grupo-adicionar">
...
<main id="main-grupos" class="tab">
    <section class="bg-white sm:p-6 lg:p-8 border-b border-gray-200 min-h-1/2" aria-labelledby="grupos-section-heading">
        <h2 id="grupos-section-heading" class="sr-only">Grupos cadastrados</h2>
        <div class="relative sm:rounded-lg">
            <?= flash()->exibir(); ?>
            <div class="bg-white rounded-lg p-6 relative">
                <section class="mb-8" id="tab-grupo-filtros">
                    <form id="form-filtros-grupos" action="/grupos/filtrar" method="GET" data-tab-form>
                        <div class="flex flex-col sm:flex-row items-center flex-wrap gap-4">
                            <div class="flex-shrink-1">
                                ...
                                <div class="bg-gray-100 p-1 rounded-lg sm:rounded-lg flex items-center justify-center flex-wrap gap-1">
                                    <button type="button" class="filter-btn-grupo tab-item active" data-tab-status="" data-tipo="" data-tab-button>Todos</button>
                                    <button type="button" class="filter-btn-grupo tab-item" data-tab-status="PADRAO" data-tipo="PADRAO" data-tab-button>Padrão</button>
                                    <button type="button" class="filter-btn-grupo tab-item" data-tab-status="CUSTOM" data-tipo="CUSTOM" data-tab-button>Customizado</button>
                                </div>
                            </div>
