...
<body class="h-full">
    <main class="grid min-h-full place-items-center bg-white px-6 py-24 sm:py-32 lg:px-8">
        <div class="text-center">
            ...
            <p class="text-base font-semibold text-sky-600"><?= $codigo ?? 'Erro' ?></p>
            <h1 class="mt-4 text-5xl font-semibold tracking-tight text-balance text-gray-900 sm:text-7xl">Ocorreu um erro</h1>
            <p class="mt-6 text-lg font-medium text-pretty text-gray-500 sm:text-xl/8">Desculpe, algo deu errado. Tente novamente mais tarde.</p>
