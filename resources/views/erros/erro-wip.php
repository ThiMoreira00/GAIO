...
<body class="h-full">
    <main class="grid min-h-full place-items-center bg-white px-6 py-24 sm:py-32 lg:px-8">
        <div class="text-center">
            ...
            <p class="text-base font-semibold text-sky-600">EM DESENVOLVIMENTO</p>
            <h1 class="mt-4 text-5xl font-semibold tracking-tight text-balance text-gray-900 sm:text-7xl">Página em construção</h1>
            <p class="mt-6 text-lg font-medium text-pretty text-gray-500 sm:text-xl/8">Esta página ainda está em desenvolvimento. Por favor, volte mais tarde.</p>
            <div class="mt-10 flex items-center justify-center gap-x-6">
                ...
                <a href="mailto:<?= $_ENV['SISTEMA_SUPORTE_EMAIL'] ?>" class="text-sm font-semibold text-gray-900">Contatar suporte <span aria-hidden="true">&rarr;</span></a>
            </div>
        </div>
    </main>
</body>
