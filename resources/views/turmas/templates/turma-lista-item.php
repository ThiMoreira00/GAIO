<template id="template-lista-item-turma">
    <div class="turma-item flex items-center gap-4 p-4 rounded-lg border border-gray-200 hover:border-sky-300 transition-colors" data-id="{{id}}">
        ...
        <div class="relative flex-shrink-0">
            <button type="button" class="inline-flex items-center p-1 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-sky-500 rounded-md turma-dropdown-trigger" id="menu-button-acoes" aria-label="Menu de acoes">
            ...
            <!-- Menu de Acoes -->
            <div id="menu-acoes" class="hidden absolute right-0 top-full z-[9999] mt-2 w-56 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-gray-400/70 py-1 turma-dropdown-menu">
                ...
                <a href="javascript:void(0);" class="flex items-center gap-3 px-4 py-2 text-sm font-semibold text-gray-700 hover:bg-gray-100 transition-colors turma-action-confirmar" data-action="confirmar" style="display: none;">
                    <span class="material-icons-sharp !text-lg">check_circle</span> Confirmar
                </a>
                <a href="javascript:void(0);" class="flex items-center gap-3 px-4 py-2 text-sm font-semibold text-gray-700 hover:bg-gray-100 transition-colors turma-action-liberar" data-action="liberar" style="display: none;">
                    <span class="material-icons-sharp !text-lg">lock_open</span> Liberar
                </a>
                <a href="javascript:void(0);" class="flex items-center gap-3 px-4 py-2 text-sm font-semibold text-green-600 hover:bg-green-50 transition-colors border-t border-gray-100 my-1 turma-action-finalizar" data-action="finalizar" style="display: none;">
...
.turma-status[data-status="CANCELADA"],
