<template id="template-espaco-modal-adicionar">
    <div id="espaco-modal-adicionar" class="modal hidden fixed inset-0 z-50 items-center justify-center bg-black/60">
        <div class="relative w-full max-w-lg rounded-lg bg-white p-6 shadow-xl">
            <div class="p-4">
                <div class="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-blue-100">
                    <span class="material-icons-sharp text-blue-600">meeting_room</span>
                </div>
                <div class="mt-3 mb-8 text-center">
                    <h3 class="text-xl font-semibold leading-6 text-gray-800 modal-title">Adicionar novo espaço</h3>
                    <p class="mt-2 text-sm text-gray-600 modal-description">Preencha as informações para adicionar um novo espaço.</p>
                </div>
                <button type="button" class="button-modal-fechar absolute right-4 top-4 text-gray-400 hover:text-gray-500">
                    <span class="material-icons-sharp">close</span>
                </button>
                <form id="espaco-form-adicionar" action="/espacos/adicionar" method="POST" class="space-y-4">
                    ...
                    <div class="mt-8 pt-4 flex flex-col-reverse gap-3 sm:flex-row sm:justify-end border-t border-gray-200">
                        ...
                        <button type="submit" class="button-primary" id="btn-adicionar-espaco">Adicionar espaço</button>
                    </div>
                </form>
            </div>
        </div>
