            ...
            <div class="bg-white p-4 sm:p-6">
                ...
                <form id="formulario-informacoes-conta" action="/configuracoes/informacoes-pessoais" method="POST" enctype="multipart/form-data" novalidate>
                    ...
                    <div class="flex items-center gap-5 mb-10">
                        ...
                        <img id="fotoPerfilImagem" src="<?= ($f = $configuracoes['usuario']?->obterCaminhoFoto()) ? obterURL('/' . $_ENV['SISTEMA_IMAGENS_PERFIL'] . $f) : obterURL('/assets/img/usuario-padrao.png'); ?>" alt="Visualização da foto de perfil de <?= $configuracoes['usuario']?->obterNomeReduzido() ?? '[em branco]' ?>" class="w-24 h-24 rounded-full object-cover ring-2 ring-gray-200">
...
<script src="<?= obterURL('/assets/javascript/utils/formulario.js'); ?>" type="application/javascript"></script>
<script src="<?= obterURL('/assets/javascript/conta/configuracoes-senha.js'); ?>" type="application/javascript"></script>
<script src="<?= obterURL('/assets/javascript/conta/configuracoes-contato.js'); ?>" type="application/javascript"></script>
<script src="<?= obterURL('/assets/javascript/conta/configuracoes-foto.js'); ?>" type="application/javascript"></script>
<script>
    ...
    new Formulario({
        ...
        notificador: {
            status: true,
            alvo: '#formulario-informacoes-conta'
        },
        onComplete: () => {
    ...
    new Formulario ({
        ...
        notificador: {
            status: true,
            alvo: '#formulario-informacoes-contato'
        },
        onComplete: () => {
