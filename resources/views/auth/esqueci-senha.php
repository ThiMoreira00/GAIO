...
<body class="flex flex-col justify-center items-center h-dvh"
    style="background-image: linear-gradient(134deg, #acd7ff, #0f3f67); background-size: contain;">
    <header class="sm:mx-auto sm:w-full sm:max-w-sm mb-8">
        <img src="<?= obterURL('/assets/img/gaio-logo-colorida-branco.png'); ?>" alt="Logotipo do Sistema GAIO"
    ...
    <main class="w-100 md:w-2/3 lg:w-1/2 xl:w-lg bg-white shadow-md rounded mx-auto">
        <section class="flex min-h-full flex-col justify-center px-6 py-4 lg:px-8">
            ...
            <div class="my-8 sm:mx-auto sm:w-full sm:max-w-sm">
                ...
                <form id="formulario-esqueci-senha" class="space-y-6" action="/esqueci-senha" method="POST">
                    <fieldset>
                        ...
                        <div class="relative mt-1">
                            ...
                            <input type="email" name="email" id="email" class="form-input pl-10" autocomplete="email"
