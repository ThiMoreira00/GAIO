...
<!-- <body class="flex flex-col justify-center items-center h-dvh" style="background-image: linear-gradient(135deg, #e0f0ff, #1a6aad); background-size: contain;"> -->
...
<main class="w-100 md:w-2/3 lg:w-1/2 xl:w-lg bg-white shadow-md rounded mx-auto">
    <section class="flex min-h-full flex-col justify-center px-8 py-4 lg:px-8">
        ...
        <div class="my-8 sm:mx-auto sm:w-full sm:max-w-sm">
            ...
            <form id="formulario-login" class="space-y-6" action="/login" method="POST">
                <fieldset>
